...
'''
Script that takes the sample images of the pitch
Finds the distortion coefficients
Stores the coefficients in undistort.txt
Displays the undistorted feed
'''
